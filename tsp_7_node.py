...
if __name__ == '__main__':
    cities = {
        ...
        'B': {'A': 0, 'B': 0, 'C': 22, 'D': 18, 'E': 40, 'F': 26, 'G': 37},
        'C': {'A': 0, 'B': 0, 'C': 0, 'D': 18, 'E': 26, 'F': 23, 'G': 50},
        'D': {'A': 0, 'B': 0, 'C': 0, 'D': 0, 'E': 15, 'F': 22, 'G': 42},
		'E': {'A': 0, 'B': 0, 'C': 0, 'D': 0, 'E': 0, 'F': 12, 'G': 10},
		'F': {'A': 0, 'B': 0, 'C': 0, 'D': 0, 'E': 0, 'F': 0, 'G': 16},
