...
if __name__ == '__main__':
    cities = {
        ...
        'B': {'A': 10, 'B': 0, 'C': 22, 'D': 18, 'E': 40, 'F': 26},
        'C': {'A': 30, 'B': 22, 'C': 0, 'D': 18, 'E': 26, 'F': 23},
        'D': {'A': 31, 'B': 18, 'C': 18, 'D': 0, 'E': 15, 'F': 22},
		'E': {'A': 20, 'B': 40, 'C': 26, 'D': 15, 'E': 0, 'F': 12},
		'F': {'A': 28, 'B': 26, 'C': 23, 'D': 22, 'E': 12, 'F': 0}
    }
