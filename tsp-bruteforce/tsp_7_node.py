...
if __name__ == '__main__':
    cities = {
        'A': {'A': 0, 'B': 10, 'C': 30, 'D': 31, 'E': 20, 'F': 28, 'G': 44},
        'B': {'A': 10, 'B': 0, 'C': 22, 'D': 18, 'E': 40, 'F': 26, 'G': 37},
        'C': {'A': 30, 'B': 22, 'C': 0, 'D': 18, 'E': 26, 'F': 23, 'G': 50},
        'D': {'A': 31, 'B': 18, 'C': 18, 'D': 0, 'E': 15, 'F': 22, 'G': 42},
		'E': {'A': 20, 'B': 40, 'C': 26, 'D': 15, 'E': 0, 'F': 12, 'G': 10},
		'F': {'A': 28, 'B': 26, 'C': 23, 'D': 22, 'E': 12, 'F': 0, 'G': 16},
		'G': {'A': 44, 'B': 37, 'C': 50, 'D': 42, 'E': 10, 'F': 16, 'G': 0}
    }
